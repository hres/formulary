...
*In user interface*
1. On the right corner of RStudio Panel, navigate to `Home/formulary/Pre-check` folder
2. Click *New Folder*
[!Panel in RStudio](./process/Snap1.jpg)
3. [!A pop window appears, input the name of folder with date of generation](./process/Snap4.jpg)
4. Using the interface, navigate to `Home/formulary/src/dist/`
5. Select the file you intend to move by clicking the empty box on the left side of the file
6. [!From the menu, click More > Move...](./process/Snap2.jpg)
7. [!From the pop up window, select the destination folder](./process/Snap3.jpg)
...
4. update filepath for DPD extracts in [dpdload.pgload](https://github.com/hres/formulary/blob/sql-views/src/sql/dpdloader/dpdload.pgload), [dpdload_ap.pgload](https://github.com/hres/formulary/blob/sql-views/src/sql/dpdloader/dpdload_ap.pgload), 
...
3. Run script `~/formulary/src/sql/test/updates_for_Release.R` to update `ccdd-mp-whitelist-draft.csv` `ccdd-ntp-definitions-draft.csv` `ccdd-tm-definitions-draft.csv` `ccdd-pseudodin-map-draft.csv` 
