...
```{r,echo=FALSE}
knitr::include_graphics('Snap5.jpg')
```
...
```{r,echo=FALSE}
knitr::include_graphics('Snap9.jpg')
```
...
```{r,echo=FALSE}
knitr::include_graphics('Snap7.jpg')
```
...
5. **Update line 57 in setup.sh** with the name of database (from PostgreSQL) for previous month release candidate generation (This will set up the correct reference data for comparisons)
