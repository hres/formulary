...
8. Create new folder with date as folder name in `~/QAfiles` and subfolder (This step can be done with user interface or at command line)
```
...
10. Check folder [QAfiles](https://github.com/hres/formulary/tree/folder_reorg/QAfiles) and email QA group
