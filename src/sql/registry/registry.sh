...
psql -d registry -c "\COPY $PGSCHEMA.release_changes_mp_${ccdd_current_date}_from_${ccdd_current_release_date} FROM '$release_changeDir/${ccdd_current_date}_from_${ccdd_current_release_date}_release_changes_mp.csv' delimiter ',' CSV HEADER";
...
psql -d registry -c "\COPY $PGSCHEMA.release_changes_ntp_${ccdd_current_date}_from_${ccdd_current_release_date} FROM '$release_changeDir/${ccdd_current_date}_from_${ccdd_current_release_date}_release_changes_ntp.csv' delimiter ',' CSV HEADER";
...
psql -d registry -c "\COPY $PGSCHEMA.release_changes_tm_${ccdd_current_date}_from_${ccdd_current_release_date} FROM '$release_changeDir/${ccdd_current_date}_from_${ccdd_current_release_date}_release_changes_tm.csv' delimiter ',' CSV HEADER";
...
psql -d registry -c "\COPY $PGSCHEMA.release_changes_mp_ntp_tm_rltnship_${ccdd_current_date}_from_${ccdd_current_release_date} FROM '$release_changeDir/${ccdd_current_date}_from_${ccdd_current_release_date}_release_changes_mp_ntp_tm_relationship.csv' delimiter ',' CSV HEADER";
...
psql -d registry -c "\COPY $PGSCHEMA.release_changes_special_groupings_${ccdd_current_date}_from_${ccdd_current_release_date} FROM '$release_changeDir/${ccdd_current_date}_from_${ccdd_current_release_date}_release_changes_special_groupings.csv' delimiter ',' CSV HEADER";
...
psql -d registry -c "\COPY $reg_schema.release_changes_mp(mp_code, mp_formal_name, mp_fr_description, changes) FROM '$release_changeDir/${ccdd_current_date}_from_${ccdd_current_release_date}_release_changes_mp.csv' delimiter ',' CSV HEADER";
...
psql -d registry -c "\COPY $reg_schema.release_changes_ntp(ntp_code, ntp_formal_name, ntp_fr_description, changes) FROM '$release_changeDir/${ccdd_current_date}_from_${ccdd_current_release_date}_release_changes_ntp.csv' delimiter ',' CSV HEADER";
...
psql -d registry -c "\COPY $reg_schema.release_changes_tm(tm_code, tm_formal_name, tm_fr_description, changes) FROM '$release_changeDir/${ccdd_current_date}_from_${ccdd_current_release_date}_release_changes_tm.csv' delimiter ',' CSV HEADER";
