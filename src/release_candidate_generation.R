...
mp_ntp_tm_relationship_rc <- mp_ntp_tm_relationship_rc %>% filter(!ntp_code == "9012412", !mp_code == "02461528")
...
deprecated_ntps <- filter(ntp_full_release_20180223) %>% 
                    ...
                    mutate(ntp_status = "Deprec",
                           ntp_status_effective_time = "20180312")

ccdd_ntp_table_rc <- bind_rows(ccdd_ntp_table_rc, deprecated_ntps)

write.csv(ccdd_ntp_table_release, file = "~/formulary/QAfiles/20180315/ntp_qa_release_20180315.csv", row.names = FALSE)
write.csv(ccdd_tm_table_release, file = "~/formulary/QAfiles/20180315/tm_qa_release_20180315.csv", row.names = FALSE)
write.csv(ccdd_mp_table_release, file = "~/formulary/QAfiles/20180315/mp_qa_release_20180315.csv", row.names = FALSE)
write.csv(mp_ntp_tm_relationship_release, file = "~/formulary/QAfiles/20180315/mp_ntp_tm_relationship_qa_release_20180315.csv", row.names = FALSE)


write.csv(ccdd_ntp_table_rc, file = "~/formulary/releases/20180315/ntp_release_candidate_20180315.csv", row.names = FALSE)
write.csv(ccdd_tm_table_rc, file = "~/formulary/releases/20180315/tm_release_candidate_20180315.csv", row.names = FALSE)
write.csv(ccdd_mp_table_rc, file = "~/formulary/releases/20180315/mp_release_candidate_20180315.csv", row.names = FALSE)
write.csv(mp_ntp_tm_relationship_rc, file = "~/formulary/releases/20180315/mp_ntp_tm_relationship_release_candidate_20180315.csv", row.names = FALSE)
